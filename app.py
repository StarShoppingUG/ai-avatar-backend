...
_TEACHING_MODE_GUIDE = (
    ...
    "warm greeting followed by asking their name — written in the STUDENT'S "
    "NATIVE LANGUAGE per the split rule above, not the language you teach. "
    "Do this even if their message was a greeting, a direct question, or a "
    "full sentence in the language you teach — treat it as an opening, not a "
    "teaching prompt yet. Do not teach any vocabulary or phrases in this reply.\n"
